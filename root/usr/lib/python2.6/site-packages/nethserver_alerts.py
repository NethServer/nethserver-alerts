...
lk = "00000000-0000-0000-0000-0000-0000-0000-0000-0000"
debug = False
HEARTBEAT_PERIOD = 90 # seconds
MAX_QUEUE_LENGTH = 50
NOTIF_FAILURE = 1
NOTIF_WARNING = 2
NOTIF_OKAY = 4
...
def heartbeat():
    ...
    endpoint = 'alerts/heartbeat?lk=%s' % lk

    try:
        response = requests.post(api_url + endpoint, data = {}, timeout = 5)
        response.json()
